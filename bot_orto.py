...
def main():
    ...
    # Cerchiamo le ore con Umidità > 88% e Temp tra 15 e 25°C (Ottimali per Peronospora/Oidio)
    ore_rischio = 0
    ...
    et_oggi = ecmwf_data["daily"]["et0_fao_evapotranspiration"][0]
    et_domani = ecmwf_data["daily"]["et0_fao_evapotranspiration"][1]
    umidita_suolo_radici = ecmwf_data["hourly"]["soil_moisture_7_to_28cm"][12] # Ore 12:00 di oggi
    ...
    t_max = icon_data["daily"]["temperature_2m_max"][0]
    t_min = icon_data["daily"]["temperature_2m_min"][0]
